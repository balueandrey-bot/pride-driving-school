        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {instructors.map((inst, idx) => (
            <motion.div 
              ...
              className="bg-[#121212] rounded-[2rem] p-6 pt-0 md:p-8 md:pt-0 relative border border-white/5 flex flex-col items-center mt-12 hover:border-white/10 transition-colors"
            >
